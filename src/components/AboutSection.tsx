...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-20 bg-community-warm">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="grid grid-cols-2 gap-4">
              {values.map((value, index) => (
                <Card key={index} className="p-6 hover:shadow-lg transition-all duration-300 bg-card border-border hover:border-primary/20">
